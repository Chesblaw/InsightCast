...
interface insightcastBannerProps {
  className?: string;
}

const insightcastBanner: React.FC<insightcastBannerProps> = ({ className = "" }) => {
  return (
    <div
          ...
          <div className="flex items-center">
            <div className="relative w-20 h-20 mr-5 group">
              ...
              <div className="relative w-full h-full bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20 flex items-center justify-center">
                <Image
                  src="/insightcast-logo-1.png"
                  alt="insightcast Logo"
                  width={56}
                  height={56}
...
export default insightcastBanner;
