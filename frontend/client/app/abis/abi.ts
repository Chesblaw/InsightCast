...
export default [
  {
    ...
    type: "impl",
    interface_name: "insightcast::interface::IPredictionHub",
  },
  {
  ...
  {
    name: "insightcast::types::Outcome",
    type: "enum",
    variants: [
      {
        name: "Option1",
  ...
  {
    name: "insightcast::types::MarketCategory",
    type: "enum",
    variants: [
      {
        name: "Normal",
  ...
  {
    name: "insightcast::types::MarketStatus",
    type: "enum",
    variants: [
      {
        name: "Active",
      ...
      {
        name: "Resolved",
        type: "insightcast::types::Outcome",
      },
      {
        name: "Closed",
        type: "()",
  ...
  {
    name: "insightcast::types::PredictionMarket",
    type: "struct",
    members: [
      {
        name: "title",
      ...
      {
        name: "choices",
        type: "(insightcast::types::Outcome, insightcast::types::Outcome)",
      },
      {
        name: "category",
        type: "insightcast::types::MarketCategory",
      },
      {
        name: "is_resolved",
        type: "core::bool",
      ...
      {
        name: "status",
        type: "insightcast::types::MarketStatus",
      },
      {
        name: "winning_choice",
  ...
  {
    name: "insightcast::types::BetActivity",
    type: "struct",
    members: [
      {
        name: "choice",
  ...
  {
    name: "insightcast::types::UserStake",
    type: "struct",
    members: [
      {
        name: "shares_a",
  ...
  {
    name: "insightcast::interface::IPredictionHub",
    type: "interface",
    items: [
      {
      ...
      },
      {
        ...
        outputs: [
          {
            type: "insightcast::types::PredictionMarket",
          },
        ],
        state_mutability: "view",
      },
      {
        ...
        outputs: [
          {
            type: "core::array::Array::<insightcast::types::PredictionMarket>",
          },
        ],
        state_mutability: "view",
      },
      {
        ...
        outputs: [
          {
            type: "core::array::Array::<insightcast::types::BetActivity>",
          },
        ],
        state_mutability: "view",
      },
      ...
      },
      {
        ...
        outputs: [
          {
            type: "insightcast::types::UserStake",
          },
        ],
        state_mutability: "view",
      },
  ...
  },
  {
    ...
    type: "impl",
    interface_name: "insightcast::admin_interface::IAdditionalAdmin",
  },
  {
    name: "insightcast::admin_interface::IAdditionalAdmin",
    type: "interface",
    items: [
      {
