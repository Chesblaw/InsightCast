...
const MarqueeSection = () => {
  const messages = [
    "insightcast: Insight is alpha",
    "insightcast is now live on testnet",
    "insightcast: Powered by starknet",
    "For partnerships and collaborations, reach contact@insightcast.com"
  ];
