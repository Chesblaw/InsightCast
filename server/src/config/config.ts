...
export const config = {
	...
	db: {
		...
		postgres: {
			port: process.env.POSTGRES_PORT || 5433, // Fixed: was POSTRES_PORT
			host: process.env.POSTGRES_HOST || "localhost",
			username: process.env.POSTGRES_USERNAME || "postgres",
			password: process.env.POSTGRES_PASSWORD || "Nati-Man",
			database: process.env.POSTGRES_DB_NAME || "insightcast",
		},
